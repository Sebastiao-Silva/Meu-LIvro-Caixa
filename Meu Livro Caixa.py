...
st.markdown("""
    ...
    /* Estilo para o botão de voltar menor */
    .btn-voltar > button {
...
if not st.session_state.logado:
    ...
    # --- TELAS INDEPENDENTES ---
        ...
        # Botão Voltar comum a todas as telas internas
        ...
        # --- PROCESSAMENTO DE VENDAS (Aparece após selecionar alguém nas telas acima) ---
        if cliente_final:
            ...
            st.markdown(f'<a href="{url}" target="_blank" style="text-decoration:none;"><div style="background-color:#25D366; color:white; padding:15px; border-radius:15px; text-align:center; font-weight:bold;">📲 ENVIAR VIA WHATSAPP</div></a>', unsafe_allow_html=True)
